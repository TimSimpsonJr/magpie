...
State: **v0.3.0** -- Layer 0-1 (Track A analysis core, document ingest, redaction,
...
+ Phase 13b `entity-crossref` (yente own-corpus / opt-in watchlist cross-ref + yente-mcp). v0.3.0
